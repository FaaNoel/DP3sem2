...
Console.WriteLine("           ==================================================== ");
		...
		Console.WriteLine("Jenis Metode Pembayaran");
		Console.WriteLine("1: ATM");
		Console.WriteLine("2: M-BANKING");
		Console.WriteLine("3: PAY PAL");
		Console.WriteLine("4: PAYONET");
		Console.WriteLine();
		Console.Write("Masukkan pilihan Anda: ");
		JenisMetode = Console.ReadLine();
		JenisMetode = JenisMetode.ToLower();
